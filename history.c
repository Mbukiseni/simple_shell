 ...
 * @info: parameter structure
 *
 * Return: count of history items if successful, otherwise returns 0
 */
...
/**
 * build_history_list - appends an entry to a linked list for history
 * @info: Structure holding possible arguments. Utilised to keep
 * @buf: buffer
 * @linecount: the count of history lines, represented as "histcount"
 *
 * Return: 0
 */
