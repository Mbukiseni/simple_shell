...
/**
 * list_to_strings - Returns an array of strings from list's "str"
...
/**
 * print_list - outputs all elements of a linked list named list_t
 * @h: pointer to the initial node
 *
 * Return: list size
 */
...
/**
 * node_starts_with - returns node with prefix string
